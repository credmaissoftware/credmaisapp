...
export const ErrorState = ({ error, title, description, onRetry, retryLabel = "Tentar novamente", compact = false }: Props) => {
  ...
  return (
    ...
    >
      {!compact && <img src="/credinho-mascot-thinking.png" alt="" aria-hidden="true" className="pointer-events-none absolute bottom-0 right-2 h-36 w-24 object-contain object-bottom opacity-[.12] grayscale animate-mascot-float" />}
